...
export default function CompanyPage() {
  return (
    <SiteFrame>
      <main>
        <PageHero title="会社情報" lead="福岡で、住まいの安心を支える地域のリフォーム会社です。" image="/service-exterior.png" alt="地域の住まいを支えるやっとる建設" position="center 58%" />
        ...
        <section className="image-copy-split section-wrap company-message">
          <div className="split-image"><Image src="/hero-living.png" alt="安心して暮らせるように整えた住まい" fill sizes="(max-width: 800px) 100vw, 52vw" /></div>
