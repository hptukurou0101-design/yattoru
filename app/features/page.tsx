...
export const metadata: Metadata = { title: "私たちの特長｜やっとる建設" };

const promises = [
  ["ご予算を踏まえて考える", "ご希望をすべて並べるだけではなく、優先したいことを一緒に整理します。ご予算の中で納得できる進め方を考えます。"],
...
export default function FeaturesPage() {
  return (
    <SiteFrame>
      <main>
        <PageHero title="私たちが大切にしていること" lead="相談しやすく、仕事はきっちり。住まいに長く向き合います。" image="/service-exterior.png" alt="丁寧に外壁と屋根を整えた住宅" position="center 58%" />
        ...
        <section className="image-copy-split section-wrap">
          <div className="split-image"><Image src="/hero-living.png" alt="暮らしに合わせて整えた住まい" fill sizes="(max-width: 800px) 100vw, 52vw" /></div>
          <div className="split-copy">
            <SectionTitle title="住まい全体を見て、必要な順番を考えます。" />
            <p>気になっている場所だけでなく、建物の状態やこれからの暮らし方も確認します。今すぐ行う工事と、少し先に考えてよい工事を整理することで、判断しやすいご提案につなげます。</p>
