...
export const metadata: Metadata = { title: "プライバシーポリシー｜やっとる建設" };
    ...
    <SiteFrame>
      <main>
        ...
        <article className="legal-page section-wrap">
          <p>やっとる建設株式会社（以下「当社」）は、お客様からお預かりする個人情報を適切に取り扱うため、以下の方針を定めます。</p>
          <section><h2>1．取得する情報</h2><p>当社は、お問い合わせやお見積もりのご依頼に際し、お名前、住所、電話番号、メールアドレス、ご相談内容、施工対象となる住まいの情報などを取得する場合があります。</p></section>
          <section><h2>2．利用目的</h2><p>取得した情報は、お問い合わせへの回答、現地調査やお見積もりのご連絡、工事の実施、アフターフォロー、当社サービスに関するご案内のために利用します。</p></section>
          <section><h2>3．第三者への提供</h2><p>法令に基づく場合を除き、ご本人の同意なく個人情報を第三者へ提供しません。工事の実施に必要な範囲で協力会社へ取り扱いを委託する場合は、適切な管理を行います。</p></section>
          <section><h2>4．安全管理</h2><p>個人情報への不正アクセス、紛失、漏えいを防ぐため、必要な安全管理措置を講じます。</p></section>
